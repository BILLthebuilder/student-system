...
//        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "000000000000", "000000000000" }));
...
//        jTextField3.setToolTipText("Enter Average");
//
...
//                                        .addComponent(jComboBox1, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
...
//                                        .addComponent(jTextField1, GroupLayout.PREFERRED_SIZE,26, javax.swing.GroupLayout.PREFERRED_SIZE))
//                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
//        Double average = Double.parseDouble(jTextField3.getText());
//        try{
...
//                PreparedStatement stmt=con.prepareStatement("update students set f_name=?, s_name=?, average=? where id=?");
//                //step4 execute query
//
...
//            Connection con=DriverManager.getConnection(url+database,user,pass);
//            //step3 create the statement object
//            String selectSQL = "SELECT id, f_name, s_name, average FROM students WHERE id = ?";
//
...
//                jTextField3.setText(String.valueOf(average));
//            }
//
//            con.close();
//
